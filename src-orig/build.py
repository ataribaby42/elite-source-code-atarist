"""Build the original Atari ST Elite with native Windows vasm and vlink (Python 3.10+)."""
...
def main():
    ...
    print('Original gameplay and novella protection enabled; Jameson starts Harmless with 100 Cr.')
    ...
    for name in ('OBJECTS.IMG', 'ELITECHR.IMG', *ASSET_NAMES):
        check(digest(GAME / name) == baseline[name], f'Original data differs: {name}')
    report = {
