...
and commander compatibility. No source imports from the Amiga or C64 tree
are used.
...
Build normally with `build_atari.bat`. For CPU tests, run
`python -m unittest discover -s src_atari/tests -p test_registration.py -v`
