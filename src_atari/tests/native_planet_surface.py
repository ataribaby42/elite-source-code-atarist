...
def make_suite(root,s):
    ...
    def render(radius=48,x=0,y=0):
        ...
        zx=2 if s.get('_geometry',{}).get('scr_rows',200)>200 else 1
        zy=zx
        if s.get('_geometry',{}).get('bpr',40)>40:zx=2
        body+=' bsr qa_fill\n'+call('clear_image')
    ...
    for colour,label in ((8,'sea'),(1,'crater')):
        init(colour)
        body+=call('clear_image')+' lea planet_rec(a6),a5\n move.w #48,scr_radius(a5)\n clr.w centre_x(a5)\n clr.w centre_y(a5)\n clr.l this_xpos(a5)\n clr.l this_ypos(a5)\n move.l #100000,this_zpos(a5)\n move.w #planet,d0\n'+call('draw_point')
