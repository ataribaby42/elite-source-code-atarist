...
and the division then raises a zero-divide exception, which AmigaOS turns into
a dead-end Guru Meditation #00000005. The docking computer
...
missiles and attacking ships homing on the player at the origin can do.
